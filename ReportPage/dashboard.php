                ...
                <div class="left-box">
                    ...
                    <div class="report-container" id="tenant-report-container">
                        ...
                        <?php
                                ...
                                $sql = "SELECT user_id, username, CONCAT(first_name, ' ', last_name) AS 'name',
                    ...
                    <div class="report-container" id="property-report-container">
                        <div class="report-text-container" id="property-report-text-container">
                            <?php
                                ...
                                $sql = "SELECT prop_id,prop_name,(usertbl.first_name) AS 'created_by_name',prop_description,created_on,max_tenants,curr_tenants,(CONCAT(street_num,' ',street_name,', ',city,', ',suburb,', ',postal_code))AS 'location'
