    ...
    <main>
                ...
                <div class="left-box">
                    <div class="prop-title-container">
                        <div class="prop-title">
                            <input type="text" class="title-text-field" placeholder="Please add a property title">
                        </div>
                    </div>
                    <div class="prop-images-container">
                        <div class="select-images-overlay">
                            <input type="file" id="file" class="inputfile" multiple>
                            <label for="files" class="inverseFilledButton">Add images</label>
                        </div>
                    </div>
                ...
                <div class="left-box">
                    ...
                    <div class="amenities-container">
                        <div class="add-amenities-overlay">
                            <button id="addAmenities" class="filledButton">Add your Amenities</label>
                        </div>
                    </div>
                    <div class="amen-addmore-container">
                        <button id="addMoreButton" class="inverseFilledButton">Add more</button>
                    </div>
                </div>
                <div class="right-box">
                    <div class="top-container">
                        <div class="agent-container">
                            <div class="agent-title">Add your tenants</div>
        ...
        <div id="loginModal" class="modal" style="display:none;">
            <div class="modal-content">
                ...
                <form id="loginForm" action="../Backend_Files/login.php?page=create" method="POST">
                    <!-- Login form fields -->
