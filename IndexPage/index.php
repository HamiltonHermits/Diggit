...
<nav class="nav" id="nav">
    <div class="navContainer">
        <div class="dash" id="dash"><svg viewBox="0 0 61 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                <mask id="mask0_30_602" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="61"
                    height="50">
                    <rect width="61" height="50" fill="#D9D9D9" />
                </mask>
                <g mask="url(#mask0_30_602)">
                    <path
                        d="M10.1665 31.25V27.0833H50.8332V31.25H10.1665ZM10.1665 22.9167V18.75H50.8332V22.9167H10.1665Z"
                        fill="#E96B09" fill-opacity="0.7" />
                </g>
            </svg>
        </div>
    ...
    <div class="mainContainer">
        ...
        <div class="searchBarContainer">
            <div class="searchBar">
                ...
                <input type="text" class="searchTerm" placeholder="Find your Digs..">
            </div>
        </div>
    ...
    <div id="loginModal" class="modal">
        <div class="modal-content">
            ...
            <?php if (isset($login_error_message)) { ?>
                ...
                <?php echo '<script>loginModal.style.display = "absolute";</script>'; ?>
            <?php } ?>
