    ...
    <div id="outer-index-sidebar-container">
        <div id="index-sidebar-container">
                    ...
                    <?php if ($_SESSION['isAdmin']) : ?>
                        <a href="../ReportPage/dashboard.php" id="reports-sidebar">
                            ...
                            <svg width="30" height="30" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <mask id="mask0_206_13" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="34" height="34">
                                    <rect width="34" height="34" fill="#D9D9D9"/>
                                </mask>
                                <g mask="url(#mask0_206_13)">
                                    <path d="M11.3337 16.9999V14.1666H22.667V16.9999H11.3337ZM11.3337 11.3333V8.49992H22.667V11.3333H11.3337ZM8.50033 19.8333H19.1253C19.81 19.8333 20.4475 19.9808 21.0378 20.276C21.6281 20.5711 22.1239 20.9902 22.5253 21.5333L25.5003 25.4291V5.66659H8.50033V19.8333ZM8.50033 28.3333H24.1545L20.2941 23.2687C20.1524 23.0798 19.9812 22.9322 19.7805 22.826C19.5798 22.7197 19.3614 22.6666 19.1253 22.6666H8.50033V28.3333ZM25.5003 31.1666H8.50033C7.72116 31.1666 7.05415 30.8892 6.49928 30.3343C5.94442 29.7794 5.66699 29.1124 5.66699 28.3333V5.66659C5.66699 4.88742 5.94442 4.2204 6.49928 3.66554C7.05415 3.11068 7.72116 2.83325 8.50033 2.83325H25.5003C26.2795 2.83325 26.9465 3.11068 27.5014 3.66554C28.0562 4.2204 28.3337 4.88742 28.3337 5.66659V28.3333C28.3337 29.1124 28.0562 29.7794 27.5014 30.3343C26.9465 30.8892 26.2795 31.1666 25.5003 31.1666Z" fill="#D9D9D9"/>
                                </g>
                            </svg>
            ...
            <a id="settings-sidebar">
                ...
                <button id="settingsButton" class="inverseFilledButton">Settings</button>
            </a>
        </div>
    </div>
    <div class="mainContainer" id="mainContainer">
        ...
        <div id="settingsModal" class="modal" style="display: none;">
            <div class="modal-content">
                ...
                <div class="modalLabel">Settings to be implemented</div>
