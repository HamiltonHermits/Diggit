...
CREATE TABLE `property_amenity` (
  `prop_amenities_id` int NOT NULL,
  `prop_id` int DEFAULT NULL,
  `amenity_id` int DEFAULT NULL,
  PRIMARY KEY (`prop_amenities_id`),
  UNIQUE KEY `prop_amenities_id_UNIQUE` (`prop_amenities_id`),
  KEY `prop_id_idx` (`prop_id`),
  CONSTRAINT `prop_id_key` FOREIGN KEY (`prop_id`) REFERENCES `property` (`prop_id`)
